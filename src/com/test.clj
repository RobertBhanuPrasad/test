(ns com.test
  (:require [com.biffweb :as biff]
            [com.test.email :as email]
            [com.test.app :as app]
            [com.test.home :as home]
            [com.test.middleware :as mid]
            [com.test.ui :as ui]
            [com.test.worker :as worker]
            [com.test.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.test.*-test"))
